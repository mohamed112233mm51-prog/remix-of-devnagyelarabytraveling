...
BEGIN
  ...
  -- Disable cash-flow triggers before deleting splits, otherwise historical
  -- balance guards can block the wipe and leave transactions/agents behind.
  ...
  v_computed := v_computed || jsonb_build_object('due', '{}'::jsonb);
