CREATE OR REPLACE FUNCTION public.app_normalize_currency(p_currency text)
RETURNS text
LANGUAGE sql
IMMUTABLE
...
GRANT EXECUTE ON FUNCTION public.app_normalize_currency(text) TO authenticated, service_role, anon;
