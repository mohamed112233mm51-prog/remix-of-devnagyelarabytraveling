...
# Match the established strict view-permission pattern used by dashboard financial cards.
replace_once(
...
# Reports: the reports edit permission continues to control treasury transfers,
# while the settlement action itself uses its own independent view permission.
replace_once(
...
replace_once(
    ...
    "gate treasury settlement action independently",
)
...
# Settings: expose the permission as an independent, view-only row.
replace_once(
