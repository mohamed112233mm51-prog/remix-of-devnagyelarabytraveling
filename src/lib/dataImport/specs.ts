...
export const IMPORT_SPECS: ImportSpec[] = [
  ...
  {
    id: "flights", label: "الرحلات", table: "flights",
    fields: [
      ...
      { key: "authority", label: "جهة السفر", type: "string", synonyms: S.authority },
      { key: "airline", label: "شركة الطيران", type: "string", synonyms: S.airline },
      { key: "travel_date", label: "تاريخ السفر", type: "date", synonyms: S.travelDate },
      baseAgent,
      { ...baseCompany, dbColumn: "issuing_company" }, // flights stores company as TEXT
      { key: "agent_price", label: "سعر الوكيل", type: "number", synonyms: S.agentPrice, default: 0 },
      { key: "company_price", label: "سعر الشركة", type: "number", synonyms: S.companyPrice, default: 0 },
      ...
      { key: "status", label: "الحالة", type: "string", synonyms: S.status, default: "محجوز" },
      { key: "notes", label: "ملاحظات", type: "string", synonyms: S.notes },
    ],
    dedupeKey: (r) =>
      `flight:${String(r.passport || r.national_id || r.passenger_name || "").trim().toLowerCase()}|${r.travel_date || ""}|${String(r.destination || "").trim().toLowerCase()}`,
  },
  {
    id: "approvals", label: "الموافقات الأمنية", table: "approvals",
    fields: [
      { key: "passenger_name", label: "اسم المسافر", type: "string", required: true, synonyms: S.passenger },
      { key: "passport", label: "رقم الجواز", type: "string", synonyms: S.passport },
      { key: "national_id", label: "الرقم القومي", type: "string", synonyms: S.nationalId },
      ...
      { key: "airline", label: "شركة الطيران", type: "string", synonyms: S.airline },
      { key: "travel_date", label: "تاريخ السفر", type: "date", synonyms: S.travelDate },
      { key: "submit_date", label: "تاريخ التقديم", type: "date", synonyms: ["تاريخ التقديم", "submit"] },
      baseAgent, baseCompany,
      { key: "agent_price", label: "سعر الوكيل", type: "number", synonyms: S.agentPrice, default: 0 },
      { key: "company_price", label: "سعر الشركة", type: "number", synonyms: S.companyPrice, default: 0 },
      { key: "price", label: "السعر", type: "number", synonyms: S.price, default: 0 },
      { key: "count", label: "العدد", type: "integer", synonyms: S.count, default: 1 },
      { key: "service_type", label: "نوع الخدمة", type: "string", synonyms: S.serviceType, default: "security_approval" },
      { key: "status", label: "الحالة", type: "string", synonyms: S.status, default: "سريعة" },
      { key: "notes", label: "ملاحظات", type: "string", synonyms: S.notes },
    ],
    dedupeKey: (r) =>
      `appr:${String(r.passport || r.national_id || r.passenger_name || "").trim().toLowerCase()}|${r.travel_date || r.submit_date || ""}`,
  },
  {
    id: "libyan-investment", label: "الاستثمار الليبي", table: "approvals",
    fields: [
      { key: "passenger_name", label: "اسم المسافر", type: "string", required: true, synonyms: S.passenger },
      { key: "passport", label: "رقم الجواز", type: "string", synonyms: S.passport },
      { key: "national_id", label: "الرقم القومي", type: "string", synonyms: S.nationalId },
      ...
      { key: "price", label: "السعر", type: "number", synonyms: S.price, default: 0 },
      { key: "count", label: "العدد", type: "integer", synonyms: S.count, default: 1 },
      { key: "service_type", label: "نوع الخدمة", type: "string", synonyms: S.serviceType, default: "استثمار ليبي" },
      { key: "status", label: "الحالة", type: "string", synonyms: S.status, default: "سريعة" },
      { key: "notes", label: "ملاحظات", type: "string", synonyms: S.notes },
    ],
    dedupeKey: (r) =>
      `linv:${String(r.passport || r.passenger_name || "").trim().toLowerCase()}|${r.travel_date || ""}`,
  },
  {
